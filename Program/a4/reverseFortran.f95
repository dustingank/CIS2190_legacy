program reverse_polish
    ...
    do
        ...
        write(*,*) "Enter the algebraic expression: "
            ...
            select case (algebraic_expression(index:index))
                ...
                case('+','-','*','/','%','^','(', ')')
                    ...
                    elseif (algebraic_expression(index:index) == ')') then
                        do
                            if (check_priority(stack(head:head)) .eq. check_priority('(')) then
                                exit
                            else
                        ...
                        head = head - 1
                        !do while(check_priority(stack(head:head)) .ne. check_priority('('))
                        !    call pop(reverse_polish_expression, stack, head, polish_length) 
                        !end do          
                    else
                        do
        ...
        write(*,*) reverse_polish_expression(1:polish_length);
